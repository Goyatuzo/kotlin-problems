    ...
    companion object {
        fun partOne(ids: List<String>): Int {
            ...
            ids.forEach { id ->
                ...
                id.forEach { ch -> count[ch] = count.getOrPut(ch) { 0 } + 1 }
        ...
        private fun commonCharacters(first: String, second: String) =
            (first.indices).fold("") { acc, curr ->
        ...
        fun solve() {
            val text =
                this::class
                    .java
                    .getResource("/adventOfCode/2018/day2.txt")
